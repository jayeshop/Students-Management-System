...
Begin VB.Form NewStd 
   ...
   Begin VB.ComboBox Combo3 
      ...
      DataSource      =   "stdInfo"
      Height          =   390
      ItemData        =   "NewStd.frx":21FCD
      Left            =   15960
      List            =   "NewStd.frx":21FDA
      TabIndex        =   10
      Text            =   "Select"
      Top             =   3360
      Width           =   1455
   ...
   Begin VB.ComboBox Combo2 
      ...
      DataSource      =   "stdInfo"
      Height          =   390
      ItemData        =   "NewStd.frx":22003
      Left            =   12000
      List            =   "NewStd.frx":22016
      TabIndex        =   9
      Text            =   "Select"
      Top             =   3360
      Width           =   1695
   ...
   Begin VB.ComboBox Combo1 
      ...
      DataSource      =   "stdInfo"
      Height          =   390
      ItemData        =   "NewStd.frx":22035
      Left            =   7080
      List            =   "NewStd.frx":2203F
      TabIndex        =   5
      Text            =   "Select"
      Top             =   1800
      Width           =   2175
   ...
   End
End
Attribute VB_Name = "NewStd"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub Command1_Click()
stdInfo.Recordset.AddNew
End Sub
